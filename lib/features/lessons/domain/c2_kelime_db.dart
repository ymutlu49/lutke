...
final kC2_Buyuk2 = [
  ...
  (id:"c2_308", ku:"Şêweyê wêjeyî", tr:"Belagat figürü / Söz sanatı", en:"Figure of speech",
   cins:"nêr", ez:"şêweyê wêjeyî", kat:"ziman", zor:0.47, not:"\"Şêweyê wêjeyî\" = söz sanatı; metafor, tezat, teşbîh vb. kapsar. Eşdeğer: \"hunera gotinê\".",
   her:["Şêweyê wêjeyî di helbestê de.", "Di şêweyê wêjeyî de hêz heye."], gen:["Şêweyê wêjeyî", "Hunera gotinê"]),
  (id:"c2_309", ku:"Figura edebî", tr:"Edebi figür", en:"Literary figure",
   cins:"mê", ez:"figura edebî", kat:"edebiyat", zor:0.47, not:"\"Figura edebî\" = edebî söz sanatı / kişileştirme, metafor, alegori. \"Hunera edebî\" eşdeğer.",
   her:["Figura edebî di romanê de.", "Di figura edebî de derbirîn heye."], gen:["Figura edebî", "Hunera edebî"]),
...
final kC2_Tamamlama = [
  ...
  (id:"c2_864", ku:"Vegotina nerasterast", tr:"Dolaylı anlatım", en:"Indirect speech",
   cins:"mê", ez:"vegotina nerasterast", kat:"rêziman", zor:0.44,
   not:"\"Vegotina nerasterast\" = dolaylı konuşma. \"Got ku ... bihata / bê / hat\" yapısı. Eşdeğer: \"axaftina nerasterast\".",
   her:["Vegotina nerasterast bi 'ku' tê çêkirin.", "Di vegotina nerasterast de dem diguhere."],
   gen:["Vegotina nerasterast", "Axaftina nerasterast"]),
...
// ════════════════════════════════════════════════════════════════
// C2 Cegerxwîn + Klasik Edebiyat (30 yeni peyv — Nisan 2026)
// Odak: Cegerxwîn, modernîte, nasname, welatparêzî, klasîk terim
// ════════════════════════════════════════════════════════════════
final kC2_Cegerxwin = [
  (id:"c2_900", ku:"ronakbîr", tr:"Aydın / Entelektüel", en:"Intellectual",
   cins:"nêr", ez:"ronakbîrê", kat:"çand", zor:0.52,
   not:"Ronak (aydınlık) + bîr (fikir). Modern Kürt terminolojisi. Cegerxwîn bağlamı.",
   her:["Ronakbîr pêwîstê civakê ye.", "Cegerxwîn ronakbîrekî mezin bû."],
   gen:["Ronakbîr", "Ronakbîrê me"]),

  (id:"c2_901", ku:"şoreş", tr:"Devrim / Ayaklanma", en:"Revolution",
   cins:"mê", ez:"şoreşa", kat:"siyaset", zor:0.48,
   not:"Klasik ve modern bağlamda devrim. Cegerxwîn şiirlerinde merkezi kavram.",
   her:["Şoreş ne hêsan e.", "Şoreşa azadiyê berdewam e."],
   gen:["Şoreş", "Şoreşa gel"]),

  (id:"c2_902", ku:"mexlûq", tr:"Yaratık / Varlık", en:"Creature / Being",
   cins:"nêr", ez:"mexlûqê", kat:"felsefe", zor:0.58,
   not:"Arapça kökenli. Klasik Kürt edebiyatında varoluş-felsefi.",
   her:["Her mexlûq hurmetê divêt.", "Mirov mexlûqê bilind e."],
   gen:["Mexlûq", "Mexlûqê dinê"]),

  (id:"c2_903", ku:"nasname", tr:"Kimlik", en:"Identity",
   cins:"mê", ez:"nasnameya", kat:"kimlik", zor:0.40,
   not:"Nas (tanımak) + name (ad). Modern neolojizm. Postkolonyal çalışmalar merkezi.",
   her:["Nasname bi ziman girêdayî ye.", "Nasnameya netewî xurt e."],
   gen:["Nasname", "Nasnameya me"]),

  (id:"c2_904", ku:"modernîte", tr:"Modernlik / Çağdaşlık", en:"Modernity",
   cins:"mê", ez:"modernîteya", kat:"felsefe", zor:0.55,
   not:"Avrupadan alıntı. Cegerxwîn modernîtenin Kürt adaptasyonunu tartışır.",
   her:["Modernîte pirsek zehmet e.", "Cegerxwîn modernîteyê rexne kir."],
   gen:["Modernîte", "Modernîteya niha"]),

  (id:"c2_905", ku:"paqijî", tr:"Temizlik / Saflık", en:"Purity / Cleanliness",
   cins:"mê", ez:"paqijiya", kat:"çand", zor:0.42,
   not:"Somut (hijyen) ve mecazî (ahlaki saflık) kullanımlar.",
   her:["Paqijî nîvê îmanê ye.", "Paqijiya dil girîng e."],
   gen:["Paqijî", "Paqijiya bedenê"]),

  (id:"c2_906", ku:"nûjenî", tr:"Modernlik / Yenilik", en:"Newness / Modernity",
   cins:"mê", ez:"nûjeniya", kat:"çand", zor:0.50,
   not:"Nû (yeni) + jen (yapmak) + î. Kürt neolojizmi — modern kavramı.",
   her:["Nûjenî pêwîst e.", "Nûjeniya li gund hat."],
   gen:["Nûjenî", "Nûjeniya serdem"]),

  (id:"c2_907", ku:"paşverûtî", tr:"Gericilik / Muhafazakarlık", en:"Backwardness",
   cins:"mê", ez:"paşverûtiya", kat:"siyaset", zor:0.56,
   not:"Paş (geri) + verû (yüzlü) + tî. Negatif konnotasyon — ideolojik terim.",
   her:["Paşverûtî pêşketinê asteng dike.", "Paşverûtiya civakê rexne dibe."],
   gen:["Paşverûtî", "Paşverûtiya siyasî"]),

  (id:"c2_908", ku:"serbilindî", tr:"Onur / Gurur", en:"Pride / Honor",
   cins:"mê", ez:"serbilindiya", kat:"kimlik", zor:0.38,
   not:"Ser (baş) + bilind (yüksek) + î. Ulusal onur — Cegerxwîn ana tema.",
   her:["Serbilindî ji me naye birîn.", "Serbilindiya netewî divê hebe."],
   gen:["Serbilindî", "Serbilindiya gel"]),

  (id:"c2_909", ku:"welatparêzî", tr:"Vatanseverlik", en:"Patriotism",
   cins:"mê", ez:"welatparêziya", kat:"siyaset", zor:0.44,
   not:"Welat (vatan) + parêz (koruyan) + î. Cegerxwîn şiirlerinin merkez sütunu.",
   her:["Welatparêzî ne tenê hîs, berpirsyarî jî ye.", "Welatparêziya Cegerxwîn bêhempa ye."],
   gen:["Welatparêzî", "Welatparêziya me"]),

  (id:"c2_910", ku:"hişmendiya netewî", tr:"Ulusal Bilinç", en:"National Consciousness",
   cins:"mê", ez:"hişmendiya", kat:"kimlik", zor:0.55,
   not:"Hişmendî (bilinç) + netewî (ulusal). Bileşik akademik terim.",
   her:["Hişmendiya netewî bi perwerdeyê ava dibe.", "Xanî hişmendiya netewî anî."],
   gen:["Hişmendiya netewî", "Hişmendiya gel"]),

  (id:"c2_911", ku:"berxwedan", tr:"Direniş", en:"Resistance",
   cins:"mê", ez:"berxwedana", kat:"siyaset", zor:0.42,
   not:"Ber (ön) + xwe (öz) + dan (vermek). Direniş — Cegerxwîn ve modern Kürt şiirinde.",
   her:["Berxwedan rûmet e.", "Berxwedana çandî jî girîng e."],
   gen:["Berxwedan", "Berxwedana ziman"]),

  (id:"c2_912", ku:"zarave", tr:"Lehçe", en:"Dialect",
   cins:"nêr", ez:"zaraveyê", kat:"ziman", zor:0.45,
   not:"Dilbilim terimi. Kurmancî, Soranî, Zazakî lehçe-zarave tartışması.",
   her:["Zarave ji zimanê cuda ne.", "Zaraveyê Behdînî di Başûr de."],
   gen:["Zarave", "Zaraveyê Kurmancî"]),

  (id:"c2_913", ku:"fonolojî", tr:"Fonoloji / Ses Bilgisi", en:"Phonology",
   cins:"mê", ez:"fonolojiya", kat:"ziman", zor:0.60,
   not:"Zanyarî dilbilim alanı. Kurmancî fonolojisi ç, ş, x, q özgün.",
   her:["Fonolojî qada ziman-nasiyê ye.", "Fonolojiya Kurmancî dewlemend e."],
   gen:["Fonolojî", "Fonolojiya ziman"]),

  (id:"c2_914", ku:"dengbêjî", tr:"Dengbêjlik / Ozanlık", en:"Dengbêj tradition",
   cins:"mê", ez:"dengbêjiya", kat:"çand", zor:0.38,
   not:"Deng (ses) + bêj (söyleyen) + î. Kürt geleneksel halk ozanlığı.",
   her:["Dengbêjî mîrasa me ye.", "Dengbêjiya Şakiro bêhempa bû."],
   gen:["Dengbêjî", "Dengbêjiya gel"]),

  (id:"c2_915", ku:"neolojîzm", tr:"Neolojizm / Yeni Sözcük", en:"Neologism",
   cins:"nêr", ez:"neolojîzmê", kat:"ziman", zor:0.62,
   not:"Yeni terim üretimi. Modern Kurmancî gelişiminde tartışılan konu.",
   her:["Neolojîzm pêwîst e.", "Neolojîzmên zoraxî nayê qebûlkirin."],
   gen:["Neolojîzm", "Neolojîzmê kurdî"]),

  (id:"c2_916", ku:"standardkirin", tr:"Standartlaştırma", en:"Standardization",
   cins:"mê", ez:"standardkirina", kat:"ziman", zor:0.55,
   not:"Ziman standardizasyonu — Bedirxan Hawar alfabesinden bugüne.",
   her:["Standardkirina Kurmancî sedsala 20an de dest pê kir.", "Standardkirina ziman dirêj e."],
   gen:["Standardkirin", "Standardkirina Kurmancî"]),

  (id:"c2_917", ku:"bîrşokbûn", tr:"Unutkanlık / Amnezi", en:"Forgetfulness / Amnesia",
   cins:"mê", ez:"bîrşokbûna", kat:"psikoloji", zor:0.58,
   not:"Bîr (hafıza) + şok (boşalmış) + bûn. Kolektif unutma — tarihsel amnezi.",
   her:["Bîrşokbûn xetereya netewî ye.", "Em bi bîrşokbûnê hatin rûxandin."],
   gen:["Bîrşokbûn", "Bîrşokbûna dîrokî"]),

  (id:"c2_918", ku:"mîras", tr:"Miras", en:"Heritage / Inheritance",
   cins:"nêr", ez:"mîrasê", kat:"çand", zor:0.40,
   not:"Maddi ve kültürel miras. Çok sık kullanım.",
   her:["Mîras divê bête parastin.", "Mîrasa edebî ya Xanî mezin e."],
   gen:["Mîras", "Mîrasa me"]),

  (id:"c2_919", ku:"tesewuf", tr:"Tasavvuf / Sufizm", en:"Sufism",
   cins:"nêr", ez:"tesewufê", kat:"felsefe", zor:0.60,
   not:"Arapça kökenli. İslam mistisizmi. Cizîrî ve Feqiyê Teyran geleneği.",
   her:["Tesewuf felsefeyeke kûr e.", "Tesewufê Cizîrî navdar e."],
   gen:["Tesewuf", "Tesewufa klasîk"]),

  (id:"c2_920", ku:"fena", tr:"Fena / Benlik Yitimi", en:"Fana / Self-annihilation",
   cins:"mê", ez:"fenaya", kat:"felsefe", zor:0.65,
   not:"Sûfî kavramı — ilahi aşkta benliğin yok olması. Şeyxê Senan destanı.",
   her:["Fena konsepta tesewufî ye.", "Di fenayê de evîn serkeftî ye."],
   gen:["Fena", "Fenaya evîndar"]),

  (id:"c2_921", ku:"Bedew", tr:"Güzel / Estetik", en:"Beautiful / Aesthetic",
   cins:"bêcins", ez:null, kat:"edebiyat", zor:0.68,
   not:"Klasik edebiyatta güzellik kavramı. Farsça \"bedew\" kökenli. Kadın güzelliği için de kullanılır.",
   her:["Bedewiya evînê di şiîrê de xuya ye.", "Bedewa şiîrê Cizîrî."],
   gen:["Bedew û rind", "Bedewiya klasîk"]),

  (id:"c2_922", ku:"etnolenguîstîk", tr:"Etnik-Dilbilim", en:"Ethnolinguistics",
   cins:"mê", ez:"etnolenguîstîka", kat:"zanist", zor:0.70,
   not:"Dilin etnik-kültürel boyutu. Modern akademik alan.",
   her:["Etnolenguîstîk qada nûjen e.", "Etnolenguîstîka Kurdî geş e."],
   gen:["Etnolenguîstîk", "Etnolenguîstîka me"]),

  (id:"c2_923", ku:"paradîgm", tr:"Paradigma", en:"Paradigm",
   cins:"mê", ez:"paradîgma", kat:"akademik", zor:0.62,
   not:"Thomas Kuhn — bilim felsefesinin temeli. Akademik C2 termini.",
   her:["Paradîgm guherîn dipejirîne.", "Paradîgma nû ava bû."],
   gen:["Paradîgm", "Paradîgma zanistî"]),

  (id:"c2_924", ku:"dîskûr", tr:"Söylem / Discourse", en:"Discourse",
   cins:"nêr", ez:"dîskûrê", kat:"akademik", zor:0.60,
   not:"Foucault sonrası akademik kullanım. Dilin iktidarla ilişkisi.",
   her:["Dîskûr desthilatê dide.", "Analîza dîskûrê zehmet e."],
   gen:["Dîskûr", "Dîskûrê siyasî"]),

  (id:"c2_925", ku:"mezhebe", tr:"Mezhep / Ekol", en:"Sect / School",
   cins:"mê", ez:"mezhebeya", kat:"felsefe", zor:0.52,
   not:"Arapça kökenli. Dini ve felsefi ekol.",
   her:["Her mezhebe dîtina xwe heye.", "Mezhebeya klasîk bû."],
   gen:["Mezhebe", "Mezhebeya sofîtiyê"]),

  (id:"c2_926", ku:"pêşrew", tr:"Öncü / Pionier", en:"Pioneer / Forerunner",
   cins:"nêr", ez:"pêşrewê", kat:"çand", zor:0.55,
   not:"Pêş (ön) + rew (giden). Öncü — akademik-sanat terimi.",
   her:["Koyî pêşrewê neteweperweriya edebî bû.", "Pêşrew cesaret dixwaze."],
   gen:["Pêşrew", "Pêşrewê me"]),

  (id:"c2_927", ku:"mîtolojî", tr:"Mitoloji", en:"Mythology",
   cins:"mê", ez:"mîtolojiya", kat:"çand", zor:0.48,
   not:"Kürt mitolojisi — Kawayê Hesinker, Newroz, Mem û Zîn.",
   her:["Mîtolojî bîra kolektîv e.", "Mîtolojiya Kurdî dewlemend e."],
   gen:["Mîtolojî", "Mîtolojiya netewî"]),

  (id:"c2_928", ku:"hermenötîk", tr:"Hermenötik / Yorumbilim", en:"Hermeneutics",
   cins:"mê", ez:"hermenötîka", kat:"felsefe", zor:0.72,
   not:"Gadamer, Ricoeur — yorumlama felsefesi. C2 uzmanlık alanı.",
   her:["Hermenötîk şiroveyê hêsan dike.", "Hermenötîka Gadamer bingehîn e."],
   gen:["Hermenötîk", "Hermenötîka nûjen"]),

  (id:"c2_929", ku:"postkolonyalî", tr:"Postkolonyalizm", en:"Postcolonialism",
   cins:"mê", ez:"postkolonyaliya", kat:"felsefe", zor:0.68,
   not:"Said, Fanon, Spivak, Bhabha — modern akademik kritik çerçeve.",
   her:["Postkolonyalî kûrbînek rexnegir e.", "Postkolonyaliya kurdî geş dibe."],
   gen:["Postkolonyalî", "Postkolonyaliya Said"]),
];

// TÜM kelimeler — vocabulary_browse_screen tarafından kullanılır
final kC2All = [...kC2Kelimeler, ...kC2_Genisleme, ...kC2_Buyuk, ...kC2_Buyuk2, ...kC2_Buyuk_ext, ...kC2_Tamamlama, ...kC2_Son109, ...kC2_Son80, ...kC2_Bitis, ...kC2_Tamam35, ...kC2_Son9, ...kC2_EkTamam, ...kC2_Cegerxwin];
