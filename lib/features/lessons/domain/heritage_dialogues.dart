...
const kDialogueB1Ninni = HeritageDialogue(
  ...
  lines: [
    ...
    DialogueLine(speakerId: 'narin31',
      kurmanci: 'Tu ev lorî ji kû fêr bûyî? Ji dêya xwe?',
      turkish: 'Bu ninniyi nereden öğrendin? Annenden mi?',
      grammarNote: '"Tu fêr bûyî" — "fêr bûn" geçişsizdir, ergatif almaz: tu + fêr bûyî.',
      audioAsset: 'assets/audio/heritage/b1_ninni_3.mp3'),
    DialogueLine(speakerId: 'piree2',
      kurmanci: 'Erê. Dêya min jî ji dêya xwe fêr bibû. Ev lorî ji nifşekî bo nifşekî çûye.\nNiha tu jî vê loriyê fêr bibe, keça min.',
      turkish: 'Evet. Annem de kendi annesinden öğrenmişti. Bu ninni nesilden nesile geçmiş.\nŞimdi sen de bu ninniyi öğren kızım.',
      grammarNote: '"Fêr bibû" = öğrenmişti (geçmiş mükemmel). "Ji nifşekî bo nifşekî" = nesilden nesile. "Fêr bibe" = öğren (2.tekil subjunctive).',
...
const kDialogueB1Mezar = HeritageDialogue(
  ...
  lines: [
    DialogueLine(speakerId: 'goran',
      kurmanci: 'Apê, ev goristan li kû ye? Ez dixwazim mezarê bapîrê xwe bibînim.',
    ...
    DialogueLine(speakerId: 'ap45',
      kurmanci: 'Bavo, ez te dibim. Bapîrê te li vê goristandê ye.\nWî gelek caran gotibû ku dixwaze te bibîne.',
    ...
    DialogueLine(speakerId: 'goran',
      kurmanci: 'Apê… [ramanên wî hatin birîn]\nEz nizanibûm ku ew heta ku ez vegeriyam ne mabû.',
    ...
    DialogueLine(speakerId: 'ap45',
      kurmanci: 'Xwedê spas. Ev soz ya pîrozê ye, kurê min. Bapîrê te jî bi kêfxweşî guhdarî dike.',
...
const kDialogueB1Heval = HeritageDialogue(
  ...
  lines: [
    ...
    DialogueLine(speakerId: 'selin',
      kurmanci: 'Ez şerm dikim ku Kurmancî nizanim.\nLê berî ku pîrêya min here, ez dixwazim ji wê fêr bibim.',
    ...
    DialogueLine(speakerId: 'ruken',
      kurmanci: 'Şermezar nebe! Ger tu fêr nebûyayî, wê hingê şerm dikira.\nNiha dest pê bike — ji nû ve.',
      turkish: 'Utanma! Öğrenmeseydin, o zaman utanırdı.\nŞimdi başla — yeniden.',
      grammarNote: '"Ger tu fêr nebûyayî" = öğrenmemiş olsaydın (gerçekleşmemiş şart). "Ji nû ve" = yeniden.',
...
const kDialogueA2Rêwîtî = HeritageDialogue(
  ...
  lines: [
    DialogueLine(speakerId: 'hasan',
      kurmanci: 'Zêynep, em li balafirgehê ne. Biletên me amade ne?',
    ...
    DialogueLine(speakerId: 'karker',
      kurmanci: 'Biletên xwe amade bikin — balafir saetek din dê were.',
