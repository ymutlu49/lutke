...
const kB1_Ev = [  // EV VE YAŞAYıŞ — 50 kelime
...
const kB1_Giyim = [  // GİYİM VE GÖRÜNÜŞ — 40 kelime
...
const kB1_Yolculuk = [  // SEYAHAT VE ULAŞIM — 60 kelime
...
const kB1_Teknoloji = [  // TEKNOLOJİ VE MEDYA — 60 kelime
...
const kB1_Saglik = [  // SAĞLIK GENİŞLEME — 50 kelime
...
const kB1_Is = [  // İŞ VE MESLEK GENİŞLEME — 50 kelime
...
const kB1_Doga = [  // DOĞA GENİŞLEME — 60 kelime
...
const kB1_Kultur2 = [  // KÜLTÜR VE SANAT GENİŞLEME — 60 kelime
...
final kB1TamListe = [
  ...
  ...kB1_Leker, ...kB1_Rêziman, ...kB1_Perwerde,
  ...kB1_Daçek2, ...kB1_Rengder, ...kB1_Cih,
...
final kB1TamListeNihaî = [
  ...kB1TamListeFinal,
  ...kB1_Ziman2, ...kB1_Kar2, ...kB1_Spor,
  ...kB1_Dema, ...kB1_Cand2, ...kB1_Dîrok2,
  ...kB1_Genel,
];
