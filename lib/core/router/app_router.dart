...
import '../../features/exercises/presentation/ku_writing_screen.dart';
...
abstract class AppRoutes {
  ...
  static const writing          = '/home/writing';  // Kurmancî yazma dedicated
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (_, __) => const KuWritingScreen(),
      ),
      GoRoute(
